...
tar --numeric-owner --group=0 --owner=0 -cf ../cif-ni-cipc.${PKG_VERSION}.ipk ./debian-binary ./data.tar.gz ./control.tar.gz

rm ./data.tar.gz
rm ./control.tar.gz

echo "Successfully created ../cif-ni-cipc.${PKG_VERSION}.ipk"
